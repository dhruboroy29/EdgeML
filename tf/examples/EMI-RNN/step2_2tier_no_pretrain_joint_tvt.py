...
parser.add_argument('-pretrain', action='store_false', default=True, help='Pretrain the components before joint training?')
...
y_updated, modelStats = emiDriver.run2tier(lowernumClasses=2, x_train=x_train,
                                           ...
                                           fracEMI=0.5, pretrain=args.pretrain,
                                           updatePolicy='top-k', predictPolicy=earlyPolicy_minProb,
                                           k=k)
