...
df = pd.read_table(filename, header=None,
                   names=['gN', 'uN', 'uR', 'wR', 'rnd', 'ep', 'it', 'bs', 'H', 'H2', 'k', 'emi_savings', 'modelsize', 'Val_Acc', 'Acc', 'Recall0', 'Recall1', 'Recall2'])
...
print("\t".join([str(i) for i in ['gN', 'uN', 'uR', 'wR', 'rnd', 'ep', 'it', 'bs', 'H', 'H2', 'k', 'emi_savings', 'modelsize', 'Val_Acc', 'Acc', 'Recall0', 'Recall1', 'Recall2']]))
