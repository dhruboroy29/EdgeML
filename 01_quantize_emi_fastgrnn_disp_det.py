...
x_test_unnorm, x_test, y_test = np.load(os.path.join(data_dir, 'x_test_unnorm.npy')),\
...
# Inferred params
NUM_BAGS = x_test_unnorm.shape[0]
NUM_SUBINSTANCE = x_test_unnorm.shape[1]
NUM_TIMESTEPS = x_test_unnorm.shape[2]
NUM_FEATS = x_test_unnorm.shape[-1]

print("x_test shape is:", x_test_unnorm.shape)
print("y_test shape is:", x_test_unnorm.shape)
